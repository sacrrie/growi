        ...
        <div className="form-group">
          ...
          <div className="custom-control custom-radio custom-control-inline ">
            <input
              ...
              onChange={() => { handleChangeFileType('markDown') }}
            />
            <label className="custom-control-label" htmlFor="customRadio1">MarkDown(.md)</label>
          </div>
          ...
          <div className="custom-control custom-radio custom-control-inline ">
            <input
              ...
              onChange={() => { handleChangeFileType('pdf') }}
            />
            <label className="custom-control-label" htmlFor="customRadio2">PDF(.pdf)</label>
          </div>
        </div>
